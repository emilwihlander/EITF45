...
kommunikationsbussen är en feltolerant och höghastighets busssystem som är utvecklad i konsensus av biltillverkare och ledande leverantörer. FlexRayen är jämför med CAN-bussen mycket snabbare men mycket dyrare. FlexRayen kan ha en payload som är mer än 30 gånger större än vad CAN kan hantera.
